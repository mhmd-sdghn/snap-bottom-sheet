...
- [`0d21f5a`](https://github.com/mhmd-sdghn/snap-bottom-sheet/commit/0d21f5a33c03cd59532c6c8a292f94f7bc10d5ad) Thanks [@mhmd-sdghn](https://github.com/mhmd-sdghn)! - 1.0 is a rewrite. The sheet is now an engine that works with any framework, with
