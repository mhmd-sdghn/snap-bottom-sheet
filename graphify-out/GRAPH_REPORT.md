...
## Corpus Check
- 65 files · ~30,414 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 565 nodes · 702 edges · 57 communities (36 shown, 21 thin omitted)
...
Cohesion: 0.05
Nodes (41): author, bugs, dependencies, @react-spring/web, @use-gesture/react, description, exports, ./package.json (+33 more)
...
Cohesion: 0.10
Nodes (19): compilerOptions, isolatedModules, jsx, lib, module, moduleResolution, noEmit, noUncheckedIndexedAccess (+11 more)
...
Cohesion: 0.07
Nodes (28): @arethetypeswrong/cli, jsdom, devDependencies, @arethetypeswrong/cli, jsdom, publint, react, react-dom (+20 more)
...
Cohesion: 0.05
Nodes (39): 1. Correctness bugs, 2. Footguns and latent bugs, 3. Performance, 4. API and DX gaps, 5. Repo / tooling gaps (vs nbridge), 6. Proposed target, 7. Found during design (addendum), P0-1 — `snapPoints` index ≠ `snapValues` index (+31 more)
...
Cohesion: 0.06
Nodes (30): dependencies, react, react-dom, @react-spring/web, snap-bottom-sheet, @use-gesture/react, devDependencies, @types/react (+22 more)
...
## Knowledge Gaps
- **291 isolated node(s):** `$schema`, `@changesets/changelog-github`, `commit`, `fixed`, `linked` (+286 more)
